...
const VideoContentPage = () => {
  return (
    <div className="w3-main" style={{ width: '90%' }}>
      <header id="portfolio" class="b-none">
        <a href="#">
          <img
      ...
      <div className="w3-black w3-center w3-padding-24">
        Powered by <a href="https://bakolo.web.app" title="W3.CSS" target="_blank" rel="noopener noreferrer" className="w3-hover-opacity">Bakolo</a>
      </div>
    </div>
  );
};
